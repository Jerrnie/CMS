<div class="inline-block" x-data="{ isOpen: false }">
    ...
    <form action="{{ route('admin.projects.edit.deliverable', ['deliverable' => $deliverable]) }}" method="POST" >
        @csrf
        @method('PUT')
                        ...
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" value="{{ $deliverable->title }}" name="title" placeholder="title" class="form-input mt-1 block w-full">
                                    </div>
                                </div>
                            </div>
                        </div>
