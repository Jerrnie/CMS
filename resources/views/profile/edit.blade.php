            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class=" max-w-6xl">
                    <ul class="flex border-b">
                        ...
                        <li class="mr-6">
                            <a href="#supportingDocuments" class="tab-button text-gray-500 hover:text-gray-700 border-b-2 border-transparent hover:border-gray-500 pb-2">Supporting Documents</a>
                        </li>
